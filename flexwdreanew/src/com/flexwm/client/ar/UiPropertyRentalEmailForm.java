...
public class UiPropertyRentalEmailForm extends UiForm {
	...
	public UiPropertyRentalEmailForm(UiParams uiParams, int id) {
		super(uiParams, new BmoEmail(), id);
		this.bmoEmail = (BmoEmail)getBmObject();
	}
	
	public UiPropertyRentalEmailForm(UiParams uiParams, int id, BmoEmail bmoEmail, BmoPropertyRental bmoPropertyRental) {
		super(uiParams, bmoEmail, id);
		this.bmoEmail = (BmoEmail)getBmObject();
		

		BmFilter emailByCustomer = new BmFilter();
		emailByCustomer.setValueFilter(bmoCustomerEmail.getKind(), bmoCustomerEmail.getCustomerId(), bmoPropertyRental.getBmoCustomer().getId());
