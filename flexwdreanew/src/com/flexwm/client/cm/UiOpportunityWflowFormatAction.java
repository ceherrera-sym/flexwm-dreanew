...
public class UiOpportunityWflowFormatAction extends Ui implements UiFormatActionHandler {
	
	
		BmoOpportunity bmoOpportunity;
		BmoWFlowFormat bmoFormat;
		String formatName = "";
		String formatLink = "";
		
		public UiOpportunityWflowFormatAction(UiParams uiParams, BmoOpportunity bmoOpportunity) {
			super(uiParams);
			this.bmoOpportunity = bmoOpportunity;
		}
		
		public UiOpportunityWflowFormatAction(UiParams uiParams, BmoOpportunity bmoOpportunity, String formatName, String formatLink) {
			super(uiParams);
			this.bmoOpportunity = bmoOpportunity;
		...
		public void send(BmObject bmObject) {
			bmoFormat = (BmoWFlowFormat)bmObject;
