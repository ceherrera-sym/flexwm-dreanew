...
public class UiProjectDetailForm2 extends UiForm{
	...
	public UiProjectDetailForm2(UiParams uiParams, Panel defaultPanel, BmoProject bmoProject) {
	...
	public void populateFields(){
		...
		formFlexTable.addStyleName("detailStart");
