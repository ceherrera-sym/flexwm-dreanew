...
import com.flexwm.client.op.UiConsultancyActiveWeekList;
...
public class UiFinanceConsultancyDash extends UiDashboard {
	protected FlowPanel dashboard = new FlowPanel();

	public UiFinanceConsultancyDash(UiParams uiParams) {
		super(uiParams, "Tablero de Finanzas", GwtUtil.getProperUrl(uiParams.getSFParams(), "/icons/fimc.png"));
	...
	public void setDashboard(BmoUser bmoUser) {
		...
		if (getUiParams().getSFParams().hasRead(new BmoConsultancy().getProgramCode())) {
			...
			UiConsultancyActiveWeekList uiConsultancyActiveWeekList = new UiConsultancyActiveWeekList(getUiParams(), orderFP, bmoUser);
			getUiParams().setUiType(new BmoConsultancy().getProgramCode(), UiParams.MINIMALIST);
			uiConsultancyActiveWeekList.show();
	...
	private void setWest() {
		...
		addActionLabel("Inicio", "fims", new ClickHandler() {
			public void onClick(ClickEvent event) {
				UiFinanceConsultancyDash uiFinanceDash = new UiFinanceConsultancyDash(getUiParams());
				uiFinanceDash.show();	  
			}
		});
