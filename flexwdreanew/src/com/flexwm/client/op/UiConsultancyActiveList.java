...
public class UiConsultancyActiveList extends UiList {
	...
	public UiConsultancyActiveList(UiParams uiParams, Panel defaultPanel) {
	...
	public UiConsultancyActiveList(UiParams uiParams, Panel defaultPanel, BmoUser bmoUser) {
		super(uiParams, defaultPanel, new BmoConsultancy());
		bmoConsultancy = (BmoConsultancy)getBmObject();	
	...
	public void postShow() {
		...
		revisionFilter.setValueFilter(bmoConsultancy.getKind(), 
				bmoConsultancy.getStatus(), 
