...
public class UiWhMovementFormOutDev extends UiFormDialog {	
	...
	UiListBox baseWhSectionListBox = new UiListBox(getUiParams(), new BmoWhSection());
	...
	public UiWhMovementFormOutDev(UiParams uiParams, int id) {
	...
	public void postShow() {
		...
		baseWhSectionListBox.setEnabled(false);
	}
	...
	public void saveNext() {
		if (newRecord) { 
			UiWhMovementFormOutDev uiWhMovementForm = new UiWhMovementFormOutDev(getUiParams(), getBmObject().getId());
