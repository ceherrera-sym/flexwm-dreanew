...
public class UiWhMovementFormRentalOut extends UiFormDialog {	
	...
	public UiWhMovementFormRentalOut(UiParams uiParams, int id) {
	...
	public void changeHeight() {
		whMovItemGrid.setPageSize(data.getList().size());
	...
	public void saveNext() {
		if (newRecord) { 
			UiWhMovementFormRentalOut uiWhMovementForm = new UiWhMovementFormRentalOut(getUiParams(), getBmObject().getId());
