...
public class UiCustomerReport extends UiReport {
	...
	public UiCustomerReport(UiParams uiParams) {
	...
	public void populateFields() {
		...
		reportTypeListBox.addItem("Reporte General de Clientes", "/rpt/cm/cust_general_report.jsp");
		reportTypeListBox.addItem("Reporte Clientes Detallado", "/rpt/cm/cust_detailed_report.jsp");
		reportTypeListBox.addItem("Estatus de Pedidos del Cliente", "/rpt/cm/cust_activeordertypes_report.jsp");
		// Si tienes permiso de ver en el modulo, mostrar el reporte
//		if (getSFParams().hasRead(bmoCreditGuarantee.getProgramCode()))
//			reportTypeListBox.addItem("Reporte Avales", "/rpt/cm/cust_creditguarantees_report.jsp");
