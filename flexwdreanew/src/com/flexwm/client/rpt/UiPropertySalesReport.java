...
public class UiPropertySalesReport extends UiReport {
	...
	public UiPropertySalesReport(UiParams uiParams) {
	...
	public void populateFields() {
		...
		reportTypeListBox.addItem("Reporte de Gestoria", "/rpt/co/prsa_propertysales_gestoria_report.jsp");	
		...
		reportTypeListBox.addItem("Reporte Admin. Comercial", "/rpt/co/prsa_propertysales_admincom_report.jsp");
