...
public class UiRaccountReport extends UiReport {
	...
	public UiRaccountReport(UiParams uiParams) {
	...
	public void populateFields() {
		...
		reportTypeListBox.addItem("Reporte Antigüedad de Saldos de CxC", "/rpt/fi/racc_paymentschedule_report.jsp");
