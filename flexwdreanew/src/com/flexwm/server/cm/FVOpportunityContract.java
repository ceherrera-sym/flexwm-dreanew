...
public class FVOpportunityContract implements IFormatPublishValidator {
	...
	public BmUpdateResult canPublish(SFParams sFParams, BmoFormat bmoFormat, String value, BmUpdateResult bmUpdateResult) {
		try {
			...
			bmUpdateResult = pmOpportunity.canPublishContract(bmoFormat, bmoOpportunity, bmUpdateResult);
