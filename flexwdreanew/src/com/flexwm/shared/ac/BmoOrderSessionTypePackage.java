...
public class BmoOrderSessionTypePackage extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField name, description, quantity, basePrice, price, amount, sessionTypePackageId, orderId;

	public BmoOrderSessionTypePackage() {
		super("com.flexwm.server.ac.PmOrderSessionTypePackage", "ordersessiontypepackages", "ordersessiontypepackageid", "ORSP", "Paquete de Sesion");
		...
		sessionTypePackageId = setField("sessiontypepackageid", "", "Paquete Sesión", 20, Types.INTEGER, false, BmFieldType.ID, false);
