...
public class BmoConsultingService extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField name, description;

	public BmoConsultingService() {
		super("com.flexwm.server.cm.PmConsultingService", "consultingservices", "consultingserviceid", "COSE", "Empresas de Consultoría");
