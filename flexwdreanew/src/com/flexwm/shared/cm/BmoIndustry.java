...
public class BmoIndustry extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField name, description;

	public BmoIndustry() {
		super("com.flexwm.server.cm.PmIndustry", "industries", "industryid", "INDU", "SIC");

		// Campo de datos
		name = setField("name", "", "Nombre", 100, Types.VARCHAR, false, BmFieldType.STRING, true);
