...
public class BmoLoseMotive extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField name, description;

	public BmoLoseMotive() {
		super("com.flexwm.server.cm.PmLoseMotive", "losemotives", "losemotiveid", "LOMT", "Motivos Perder");
