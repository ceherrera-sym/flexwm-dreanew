...
public class BmoMaritalStatus extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField name, description;

	public BmoMaritalStatus() {
		super("com.flexwm.server.cm.PmMaritalStatus", "maritalstatus", "maritalstatusid", "MAST", "Estado Civil");

		// Campo de datos
		name = setField("name", "", "Estado Civil.", 100, Types.VARCHAR, false, BmFieldType.STRING, true);
