...
public class BmoNationality extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField name, description;

	public BmoNationality() {
		super("com.flexwm.server.cm.PmNationality", "nationalities", "nationalityid", "NATY", "Nationality");

		name = setField("name", "", "Nacionalidad", 100, Types.VARCHAR, false, BmFieldType.STRING, true);
