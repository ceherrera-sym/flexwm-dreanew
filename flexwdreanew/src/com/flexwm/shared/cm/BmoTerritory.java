...
public class BmoTerritory extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField name, description;

	public BmoTerritory() {
		super("com.flexwm.server.cm.PmTerritory", "territories", "territoryid", "TERR", "Territorios");
		name = setField("name", "", "Nombre Territorio", 60, Types.VARCHAR, false, BmFieldType.STRING, true);
