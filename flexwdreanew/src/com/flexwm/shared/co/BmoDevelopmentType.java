...
public class BmoDevelopmentType extends BmObject implements Serializable{
	private static final long serialVersionUID = 1L;
	private BmField code, name, description;
	public static String CODE_PREFIX = "DT-";

	public BmoDevelopmentType() {
		super("com.flexwm.server.co.PmDevelopmentType", "developmenttypes", "developmenttypeid", "DEVT", "Tipos de Desarrollo");

		//Campo de Datos		
		code = setField("code", "", "Clave Tipo D.", 10, Types.VARCHAR, true, BmFieldType.CODE, true);
