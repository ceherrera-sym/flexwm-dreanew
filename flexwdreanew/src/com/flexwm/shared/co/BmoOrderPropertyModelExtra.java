...
public class BmoOrderPropertyModelExtra extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField quantity, comments, price, amount, propertyModelExtraId, orderId;

	BmoPropertyModelExtra bmoPropertyModelExtra = new BmoPropertyModelExtra();

	public static String ACTION_GETPROPERTYMODEL = "ORPX_GETPROPERTYMODEL";

	public BmoOrderPropertyModelExtra() {
		super("com.flexwm.server.co.PmOrderPropertyModelExtra", "orderpropertymodelextras", "orderpropertymodelextraid", "ORPX", "Extras de la Propiedad");
