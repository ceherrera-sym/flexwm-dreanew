...
public class BmoRaccountAssignment extends BmObject implements Serializable {
	...
	// IMPORTATE: SI SE VA A MODIFICA ESTE ARCHIVO SE DEBE CAMBIAR EN BmoRaccountAssignmentParent.java TAMBIEN, YA QUE ES UNA COPIA
	
	public BmoRaccountAssignment() {
		super("com.flexwm.server.fi.PmRaccountAssignment", "raccountassignments", "raccountassignmentid", "RASS", "Aplicaciones CxC");
	...
	public ArrayList<BmSearchField> getSearchFields() {
		return new ArrayList<BmSearchField>(Arrays.asList(
				new BmSearchField(getForeignRaccountId())
				));
	}
