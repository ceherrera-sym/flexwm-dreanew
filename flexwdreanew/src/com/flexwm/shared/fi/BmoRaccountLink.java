...
public class BmoRaccountLink extends BmObject implements Serializable {
	...
	public BmoRaccountLink() {
		super("com.flexwm.server.fi.PmRaccountLink", "raccountlinks", "raccountlinkid", "RALK", "Relacionadas");
