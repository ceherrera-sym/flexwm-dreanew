...
public class BmoDiscount extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField code, name, description;

	public BmoDiscount() {
		super("com.flexwm.server.in.PmDiscount", "discounts", "discountid", "DISC", "Descuentos");
		code = setField("code", "", "Clave Descuento", 10, Types.VARCHAR, false, BmFieldType.CODE, true);
