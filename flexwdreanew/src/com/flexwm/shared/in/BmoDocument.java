...
public class BmoDocument extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField code, name, description;

	public BmoDocument() {
		super("com.flexwm.server.in.PmDocument", "documents", "documentid", "DOCU", "Documentos");
		code = setField("code", "", "Clave Documento", 10, Types.VARCHAR, false, BmFieldType.CODE, true);
