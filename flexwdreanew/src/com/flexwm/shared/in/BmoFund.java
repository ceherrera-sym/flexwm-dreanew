...
public class BmoFund extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField code, name, description;

	public BmoFund() {
		super("com.flexwm.server.in.PmFund", "funds", "fundid", "FUND", "Fondos");
		code = setField("code", "", "Clave Fondo", 10, Types.VARCHAR, false, BmFieldType.CODE, true);
