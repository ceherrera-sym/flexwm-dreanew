...
public class BmoGoal extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField code, name, description;

	public BmoGoal() {
		super("com.flexwm.server.in.PmGoal", "goals", "goalid", "GOAL", "Objetivos");
		code = setField("code", "", "Clave Objetivo", 10, Types.VARCHAR, false, BmFieldType.CODE, true);
