...
public class BmoInsuranceCategory extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField code, name, description;

	public BmoInsuranceCategory() {
		super("com.flexwm.server.in.PmInsuranceCategory", "insurancecategories", "insurancecategoryid", "INCA", "Categoría Prod/Seg");
		code = setField("code", "", "Clave Categoría", 10, Types.VARCHAR, false, BmFieldType.CODE, true);
