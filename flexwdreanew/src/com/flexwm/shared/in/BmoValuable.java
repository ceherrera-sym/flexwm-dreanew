...
public class BmoValuable extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField code, name, description;

	public BmoValuable() {
		super("com.flexwm.server.in.PmValuable", "valuables", "valuableid", "VALU", "Valores");
		code = setField("code", "", "Clave Valor", 10, Types.VARCHAR, false, BmFieldType.CODE, true);
