...
public class BmoMissingProfile extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField  orderTypeId,profileId;
	private BmoProfile bmoProfile = new BmoProfile();
	
	public BmoMissingProfile() {
		super("com.flexwm.server.op.PmMissingProfile","missingprofiles", "missingprofileid", "MIPR", "Perfiles Faltantes en Devolucion");
