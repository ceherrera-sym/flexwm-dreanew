...
public class BmoProductFamily extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField name, description;

	public BmoProductFamily() {
		super("com.flexwm.server.op.PmProductFamily", "productfamilies", "productfamilyid", "PRFM", "Familias de productos");
		// Campo de datos
		name = setField("name", "", "Nombre Familia", 30, Types.VARCHAR, false, BmFieldType.STRING, true);
