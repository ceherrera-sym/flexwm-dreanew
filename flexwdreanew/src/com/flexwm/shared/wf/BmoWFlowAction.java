...
public class BmoWFlowAction extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField code, name, description, className;

	public BmoWFlowAction() {
		super("com.flexwm.server.wf.PmWFlowAction", "wflowactions", "wflowactionid", "WFAC", "Acciones Tarea");
		
		// Campos de datos
		this.code = setField("code", "", "Clave Acc.", 10, Types.VARCHAR, false, BmFieldType.CODE, true);
