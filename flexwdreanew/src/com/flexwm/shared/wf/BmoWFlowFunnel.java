...
public class BmoWFlowFunnel extends BmObject implements Serializable {
	private static final long serialVersionUID = 1L;
	private BmField name, description;

	public BmoWFlowFunnel() {
		super("com.flexwm.server.wf.PmWFlowFunnel", "wflowfunnels", "wflowfunnelid", "WFLF", "Funnel");

		name = setField("name", "", "Nombre Funnel", 100, Types.VARCHAR, false, BmFieldType.STRING, false);
