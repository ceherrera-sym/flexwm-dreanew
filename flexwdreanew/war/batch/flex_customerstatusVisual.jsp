...
<body class="default">
	...
	<br>
	<FORM action="flex_customerstatusVisual.jsp" method="POST" name="listFilter">
...
// 							System.out.println("Cliente: "+  pmConn.getInt("cucp_customerid"));
							...
							if (pmConnCustomerStatus.next()) {
								BmoCustomerStatus bmoCustomerStatus = new BmoCustomerStatus();
								bmoCustomerStatus = (BmoCustomerStatus) pmCustomerStatus.get(pmConnCustomerStatus.getInt("csta_customerstatusid"));
