...
<table border="0" cellspacing="0" cellpading="0" width="100%">
	...
	<tr>
		<td>
			<b>Proceso Oportunidades perdidas, se llena la primera tarea y la ultima(perder): CORPORATIVO</b><br>
			<%			
			...
			try {
				...
				while(pmConn.next()){
					// fase (5)OPRCOR
					if(pmConn.getString("wfsp_code").equals("PERDER") || pmConn.getInt("wfsp_wflowphaseid") == 5){
