...
<table border="0" cellspacing="0" cellpading="0" width="100%">
	...
	<tr>
		<td>
			<b>Proceso Oportunidades perdidas, se llena la primera tarea y la ultima(perder): GOBIERNO</b><br>
			...
			try {
				...
				while(pmConn.next()){
					// fase (19)OPRGOB
					if(pmConn.getString("wfsp_code").equals("PERDER") || pmConn.getInt("wfsp_wflowphaseid") == 19){
