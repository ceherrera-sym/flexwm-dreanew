...
<table border="0" cellspacing="0" cellpading="0" width="100%">
	...
	<tr>
		<td>
			<b>Proceso Oportunidades Ganadas SOCIALES, llena las tareas hasta ganar</b><br>
			...
			try {
				...
				String sql = " SELECT * FROM opportunities " +
								...
								" WHERE oppo_status = '" + BmoOpportunity.STATUS_WON + "'" + 
								" AND wfsp_progress < 100 " +
								" AND wfty_code = 'OPRSOC' " +
								" AND oppo_opportunityid >= 1000 "+
								" AND oppo_opportunityid < 1300";
				...
				while(pmConn.next()){
					if(!pmConn.getString("wfsp_code").equals("PERDER")){
