...
<table width="100%" height="50%" border="0" align="center"  class="detailStart">	
    <tr class="reportSubTitle">
        <td colspan="1" align="left" width="99%" height="35" class="reportCellEven">
          ...
          <li>Formato (| = tab): Codigo | Nombre | Razon Social |  Descripcion | Tipo | Categoria | RFC | Reprensentante legal | IMSS | Moneda | Regimen | Telefono | Email | Email Conciliar? | Notaria No. | Nom. Notario | No.Escritura |  Fecha Escritura | Ciudad Escritura </li>
        </td>
    </tr>    
    <TR>
        <td colspan="3">  
            <TABLE cellpadding="0" cellspacing="0" border="0"  width="80%">
                ...
                <tr class="">
                    <td align="center" colspan="4" height="35" valign="middle">
                        <input type="submit" class="formSaveButton" value="Siguiente">
                    </td>
                </tr>			    
                </FORM>								
            </TABLE>
