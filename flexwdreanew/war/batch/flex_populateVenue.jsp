...
<table width="100%" height="50%" border="0" align="center"  class="detailStart">	
    <tr class="reportSubTitle">
        <td colspan="1" align="left" width="99%" height="35" class="reportCellEven">
          ...
          <li>Formato (| = tab): Codigo |Nombre | Descripcion  | Calle | Numero | Colonia | C.P. | Ciudad | www | Contacto | Email | Telefono | Extension | Domicilio Particular? | Delegación | Liga para Planos   </li>
        </td>
    </tr>    
    <TR>
        <td colspan="3">  
