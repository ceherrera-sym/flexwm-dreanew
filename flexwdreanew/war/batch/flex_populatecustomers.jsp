...
<table width="100%" height="50%" border="0" align="center"  class="detailStart">	
    <tr class="reportSubTitle">
        <td colspan="1" align="left" width="99%" height="35" class="reportCellEven">
          ...
          <li>Formato (| = tab): Cliente | Razon Social | Tipo | RFC | F.Creacion | Titulo | Nombre | Parterno | Materno | Nacimiento | Telefono | Movil | Email | Cargo | Vendedor | Sitio Web | Moneda | Referencia | SIC | Territorio | Servicio Por </li>
        </td>
    </tr>    
    <TR>
        <td colspan="3">  
