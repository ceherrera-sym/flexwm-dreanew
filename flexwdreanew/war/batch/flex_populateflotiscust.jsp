...
<table width="100%" height="50%" border="0" align="center"  class="detailStart">	
    <tr class="reportSubTitle">
        <td colspan="1" align="left" width="99%" height="35" class="reportCellEven">
          ...
          <li>Formato (| = tab): Tipo | Nombre | Parterno | Materno | Nacimiento | Genero | Vendedor | Padre | Nombre | Paterno | Materno | Madre | Nombre | Paterno | Materno | Celular | Telefono | Email | Responsable</li>
        </td>
    </tr>    
    <TR>
        <td colspan="3">  
