...
<table width="100%" height="50%" border="0" align="center"  class="detailStart">	
    <tr class="reportSubTitle">
        <td colspan="1" align="left" width="99%" height="35" class="reportCellEven">
          ...
          <li>Formato (| = tab): Codigo | Email | Nombre | A. Paterno | A. Materno | Fecha de Nac. | Tipo de sangre | Telefono | Movil | Empresa | Departamento | Ubucación | Superior | Fecha Ing | Fecha baja | # Empleado | RFC | CURP | IMSS | Facturable? | Tarifa Hr | Notas | Interfaz | Programa de inicio | ID Cal. Google | Estatus </li>
        </td>
    </tr>    
    <TR>
        <td colspan="3">  
