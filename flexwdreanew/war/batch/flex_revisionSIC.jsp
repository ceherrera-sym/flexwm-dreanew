...
%>
	...
	<TABLE cellpadding="0" cellspacing="0" border="0"  width="100%">
		<FORM action="flex_revisionSIC.jsp" method="POST" name="listFilter">	
...
<% } else if (action.equals("populate")) {
	...
	try {		
		...
		while (inputData.hasMoreTokens() && i < 20000) { 
			...
			//bmoIndustry.getCode().setValue(code);
			bmoIndustry.getName().setValue(name);
			
			pmIndustry.save(pmConn, bmoIndustry, bmUpdateResult);
	...
	response.sendRedirect("/batch/flex_revisionSIC.jsp?action=complete&errorsave=" + bmUpdateResult.errorsToString());
