...
%>
        ...
        <td colspan="4">  
    		...
    		%>
    				...
    				<TR class="reportCellEven" width="100%">
    					...
    					<%=HtmlUtil.formatReportCell(sFParams, wflowUserId, BmFieldType.STRING)%>
	...
	<TABLE cellpadding="0" cellspacing="0" border="0"  width="100%">
		<FORM action="flex_revisionWflowUser.jsp" method="POST" name="listFilter">	
...
<% } else if (action.equals("populate")) {
	...
	try {		
		...
		while (inputData.hasMoreTokens() && i < 20000) { 
			...
			//bmoWflowUser = (BmoWFlowUser)pmWFlowUser.get(Integer.parseInt(wflowUserId));
			
			
			sql = " update wflowusers set wflu_userid = " + userId + " where wflu_wflowuserid = " + wflowUserId;
			pmConn.doUpdate(sql);
	...
	response.sendRedirect("/batch/flex_revisionWflowUser.jsp?action=complete&errorsave=" + bmUpdateResult.errorsToString());
