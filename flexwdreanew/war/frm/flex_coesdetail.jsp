...
<%
String title = "Detalle de la Estimaci&oacute;n.";
...
try {
 ...
 <table border="0" cellspacing="0" width="100%" cellpadding="0" style="font-size: 12px">
	<tr>
		...
		<td class="documentTitle" align="center"><%= title %> No.<%= bmoContractEstimation.getConsecutive().toInteger() %><br>Elaborada el:
			<%= SFServerUtil.nowToString(sFParams, sFParams.getBmoSFConfig().getPrintDateTimeFormat().toString()) %>
		</td>
		<td class="documentComments" align="left"><b>C&oacute;digo del Documento: FO-07.5.2.1-1 <br> (30-Sep-04)</b></td>
	</tr>			
</table>
...
<table border="0" cellspacing="0" width="100%" cellpadding="0">
	...
	<tr>
	  ...
	  <td class="documentLabel" align ="left" colspan="">Fecha de Terminaci&oacute;n:</td>
	  <td class="documentText" align ="left" colspan="">&nbsp;
...
<table border="0" cellspacing="0" width="100%" cellpadding="0" class="">
	...
	<TR class="">
		...
		<td class="reportHeaderCellRight">Precio U.</td>
		<td class="reportHeaderCellCenter">Anterior</td>
		<td class="reportHeaderCellCenter">Concepto</td>
		<td class="reportHeaderCellCenter">Acum.</td>
...
%>
		<TR class="reportCellEven">				
			...
			<%=HtmlUtil.formatReportCell(sFParams, "" + bmoEstimationItem.getBmoContractConceptItem().getQuantity().toDouble(),BmFieldType.NUMBER)%>
...
<% } %>
	<tr>
		<td colspan="8" class="reportHeaderCellRight">			
			Importe Total: &nbsp;	
		</td>
		<td class="documentText" align ="right" colspan="">
			<b><%= SFServerUtil.formatCurrency(bmoContractEstimation.getAmount().toDouble()) %></b>
		</td>
	</tr>		
...
<table border="0" cellspacing="0" width="100%" cellpadding="0">
	<TR class="">
		<script language="javascript">
			alert("La Estimación no esta autorizada");
		</script>
	</TR>
</table>	
<%		
