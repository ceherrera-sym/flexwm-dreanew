...
<%
	String title = "Contrato Compra-Venta Casas Arancia";
...
<p align="center" class="contractTitle">
	<b>A N T E C E D E N T E S:</b>
</p>

<p align="justify" >
	<b>PRIMERO .- </b> Mediante Escritura P&uacute;blica <b>98,650</b> de fecha <b>28</b> de <b>Julio del 2015</b>, tirada ante la fe del 
	<b>Lic. PABLO FRANCISCO TORIELLO ARCE</b>, Titular de la Notaria P&uacute;blica n&uacute;mero <b>65</b> en Legal Ejercicio del Partido Judicial de 
	<b>Le&oacute;n, Guanajuato</b>, registrada bajo el folio real <b>R20*490899</b> el d&iacute;a <b>9 de Septiembre del 2015</b> en el 
	<b>Registro P&uacute;blico de la Propiedad</b> de <b>Le&oacute;n, Guanajuato</b>, se formaliz&oacute; el contrato de compra-venta entre 
	<b>JOSE ROBERTO FLORES SANCHEZ e ISMAEL RIVERA JIMENEZ</b> con <b><%= bmoCompany.getLegalName().toString() %>, 
	SOCIEDAD AN&Oacute;NIMA DE CAPITAL VARIABLE</b>, respecto del bien inmueble ubicado en, 
	parcela <b>39 Z-1 P-2/2, del ejido de Ibarrilla</b>, perteneciente al municipio de <b>Le&oacute;n, Guanajuato</b>.
</p>
<p align="justify" >
	<b>SEGUNDA .- </b> Mediante Escritura P&uacute;blica n&uacute;mero <b>98,651</b> de fecha <b>28 de Julio del 2015</b>, otorgada ante la fe del 
	<b>Lic. PABLO FRANCISCO TORIELLO ARCE</b>, Titular de la Notaria P&uacute;blica n&uacute;mero <b>65</b> en Legal Ejercicio del Partido Judicial de 
	<b>Le&oacute;n, Guanajuato</b>, registrada bajo el folio real <b>R20*490899</b> el d&iacute;a <b>9 de Septiembre del 2015</b> en el
	<b>Registro P&uacute;blico de la Propiedad</b> de <b>Le&oacute;n, Guanajuato</b>, se hizo constar el <b>CONTRATO DE FIDEICOMISO</b> n&uacute;mero <b>11039070</b>, 
	uno uno cero tres nueve cero siete cero, en el que <b>"SCOTIABANK INVERLAT", S.A., INSTITUCI&Oacute;N DE BANCA M&Uacute;LTIPLE, GRUPO FINANCIERO SCOTIABANK INVERLAT</b>, 
	ostenta el caracter de <b>FIDUCIARIO</b> y propietario de los bienes que integran el <b>FIDEICOMISO</b>, 
	manteniendo la posesi&oacute;n del inmueble original el <b>FIDEICOMITENTE (<%= bmoCompany.getLegalName().toString() %>), 
	con el objeto de promocionar la edificaci&oacute;n y comercializaci&oacute;n de bienes inmuebles</b>.
</p>
...
<p align="justify" >
	...
	tirada ante la fe del notario p&uacute;blico n&uacute;mero 
	<b><%= bmoCompany.getDeedNotaryNumber().toString().toUpperCase() %></b> 
	de este partido judicial y debidamente registrada en el registro p&uacute;blico y de comercio y ante las autoridades 
	fiscales con Registro Federal de Contribuyente 
	<b><%= bmoCompany.getRfc().toString().toUpperCase() %></b>.
</p>

<p align="justify" >
	<b>SEGUNDA:</b> Declara la &quot;VENDEDORA&quot; ser leg&iacute;tima propietaria de los lotes de terreno ubicados 
	...
	en los cuales se construir&aacute;n viviendas descritas en el <b>ANEXO 1</b> del presente contrato de promesa de compra venta y 
...
<p align="justify" >
	<b>SEGUNDA</b>. - El "COMPRADOR" se obliga a pagar al "VENDEDOR" ambos convienen como precio de la compra-venta de la vivienda se&ntilde;alada
	en el cuerpo del presente instrumento, la cantidad de <b><%= SFServerUtil.formatCurrency(bmoOrder.getTotal().toDouble()) %></b> 
	(<b><%= amountByWord.getMoneyAmountByWord(bmoOrder.getTotal().toDouble()).toUpperCase() %></b>) misma que deber&aacute; cubrir a m&aacute;s
	tardar el dia  de la firma de las escrituras que formalicen el acto ante la fe del NOTARIO P&Uacute;BLICO que para este efecto
	designe el "VENDEDOR".
	
<p align="justify" >
	<b>TERCERA</b>. -EL "COMPRADOR" se obliga a cubrir los gastos que se deriven del aval&uacute;o
	de la vivienda as&iacute; como los correspondientes a la escrituraci&oacute;n.
</p>
	
<p align="justify" >
	A la firma del presente contrato el valor de la vivienda es <b><%= SFServerUtil.formatCurrency(bmoOrder.getTotal().toDouble()) %></b>
	(<b><%= amountByWord.getMoneyAmountByWord(bmoOrder.getTotal().toDouble()).toUpperCase() %></b>)
	monto que podr&iacute;a ser actualizado si se modificara el salario m&iacute;nimo mensual del Distrito Federal. 
	El precio de venta ser&aacute; ajustado al alza en el caso de que transcurran 12 (doce) meses o m&aacute;s a partir de la fecha de firma 
	del presente instrumento, y el "COMPRADOR" no haya liquidado al "VENDEDOR" el monto total del valor de venta, independientemente del motivo
	por el cual no se haya realizado el pago acorde a las obligaciones establecidas en este acuerdo de voluntades.
</p>
...
<ol type="1" style="text-align:justify;">
	<li>
		Para el supuesto de actualizarse la hip&oacute;tesis en la cual exista una diferencia respecto al valor de venta de la vivienda 
		materia del presente contrato, y la fecha efectiva en que se realice la liquidaci&oacute;n de dicha obligaci&oacute;n, podr&aacute; ser pagada 
		al "VENDEDOR" de contado o a trav&eacute;s de un cr&eacute;dito mediante alguna instituci&oacute;n financiera, autofinanciamiento y/o cr&eacute;dito directo:
	</li>
</ol>
<ol type="a" >
	<li>
	...
	<li>
		...
		m&aacute;s intereses al <b>"VENDEDOR"</b> en la forma pactada y avalada por pagar&eacute;s, descritos en el Anexo 2 del presente instrumento, diferencia que puede
	...
	<li>
		Si la opci&oacute;n fue la de cr&eacute;dito directo, se deber&aacute; firmar la corrida financiera anexa <b>(ANEXO 4)</b> correspondiente que incluir&aacute;
...
<p align="justify" >
	<b>CUARTA.- </b> - El <b>"COMPRADOR"</b> pagar&aacute; al <b>"VENDEDOR"</b> la diferencia que resulte a su cargo, 
	de acuerdo a lo que se menciona en el punto 1 (uno) inciso b) de la cl&aacute;usula Segunda de este contrato; 
	la cual se har&aacute; en el lugar y las fechas establecidas en los pagar&eacute;s y/o cuando se lo
	indique el <b>"VENDEDOR"</b> previo a la firma de escrituras.
	<p>
	Los pagos los realizara el <b>"COMPRADOR"</b> en la siguiente cuenta bancaria:
...
<p align="justify"  >
	<b>QUINTA</b>.- Convienen ambas partes de este contrato de compra venta que el pago no
...
<p align="justify" >
	<b>SEXTA</b>.- En el supuesto de que el cr&eacute;dito fuere negado al "COMPRADOR" por la instituci&oacute;n 
...
<p align="justify" >
	<b>S&Eacute;PTIMA</b>.- En el supuesto que el "COMPRADOR" no entregue con oportunidad
...
<p align="justify" >
	<b>OCTAVA</b>.- En el supuesto de que al "COMPRADOR" se le niegue el otorgamiento del cr&eacute;dito hipotecario, estar&aacute; en posibilidad de liquidar 
...
<p align="justify" >
	<b>NOVENA</b>.- Las partes acuerdan que  si el "COMPRADOR" llegare a retrasarse en m&aacute;s 
...
<p align="justify" >
	<b>D&Eacute;CIMA</b>.- El comprador est&aacute; enterado y consciente de las caracter&iacute;sticas, materiales de construcci&oacute;n, dise&ntilde;o, dimensiones, superficies y ubicaci&oacute;n de la 
...
<p align="justify" >
	<b>D&Eacute;CIMA PRIMERA</b>.- Si el "COMPRADOR" llegare a cancelar el presente contrato de promesa de compra venta
...
<p align="justify" >
	<b>D&Eacute;CIMA SEGUNDA</b>.-  El "VENDEDOR"  se obliga a transmitir a el "COMPRADOR" el
...
<p align="justify" >
	<b>D&Eacute;CIMA TERCERA</b>.- EL "COMPRADOR", esta enterado y es consciente que en caso que haya sido sujeto al subsidio federal 
...
<p align="justify" >
	<b>D&Eacute;CIMA CUARTA</b>.- Ambas partes contratantes declaran que en este convenio no 
...
<p align="justify" >
	<b>D&Eacute;CIMA QUINTA</b>.- Para la interpretaci&oacute;n, cumplimiento, y, ejecuci&oacute;n del presente 
...
<p align="justify" >
	<b>D&Eacute;CIMA SEXTA</b>.- <b>El "COMPRADOR" declara que conoce la existencia del fideicomiso n&uacute;mero 11039070, 
	que los derechos de cobro de la presente compra venta son a favor de "SCOTIABANK INVERLAT", S.A., INSTITUCI&Oacute;N DE BANCA M&Uacute;LTIPLE, 
	GRUPO FINANCIERO SCOTIABANK INVERLAT, en su car&aacute;cter de fiduciario del mencionado fideicomiso y su aceptaci&oacute;n expresa 
	respecto a la cesi&oacute;n de estos derechos.</b>
</p>

<p align="justify" >
	<b>D&Eacute;CIMA S&Eacute;PTIMA</b>.- <b>El "VENDEDOR" declara que sabe y est&aacute; de acuerdo en que los Derechos de Cobro son irrevocables, 
	por lo cual, el "COMPRADOR" efectuar&aacute; los pagos respectivos en la cuenta de cobranza, mencionada en la cl&aacute;usula 
	TERCERA del presente contrato, en tanto no reciba carta expresa del Fiduciario con instrucci&oacute;n diversa.</b>
</p>
	
<p align="justify" >
	<b>D&Eacute;CIMA OCTAVA</b>.- <b>El fideicomitente podr&aacute; efectuar cambios en el presente contrato, 
	exclusivamente cuando existe autorizaci&oacute;n previa del Fideicomisario en Primer Lugar y dichos cambios solo podr&aacute;n ser 
	referentes a los montos a depositar, fecha de pago o la cuenta en la cual se realizar&aacute;n los dep&oacute;sitos.</b>
</p>
	
<p align="justify" >
	<b>D&Eacute;CIMA NOVENA</b>.- Los recursos depositados materia de la presente operaci&oacute;n en la cuenta que se se&ntilde;ala en la cl&aacute;usula 
	Tercera (Cuenta Cobranza Fideicomiso 11039070) se reciben por cuenta y orden de <%= bmoCompany.getLegalName().toString() %>  
	sin ninguna responsabilidad para el Fiduciario solo para efectos de Administraci&oacute;n conforme a lo estipulado 
	en el Fideicomiso 11039070, no siendo en ning&uacute;n momento responsable de aspecto alguno respecto al Proyecto, 
	su construcci&oacute;n y mucho menos de la transmisi&oacute;n a favor del Adquirente. 
	El presente contrato solo obliga al "VENDEDOR" y al "COMPRADOR".
</p>
	
<p align="justify" >
	<b>VIG&Eacute;SIMA</b>.- Ser&aacute; responsabilidad del Fideicomitente y/o Fideicomisairo en Segundo Lugar, la expedici&oacute;n y 
	entrega de los recibos por concepto de pago a favor del "COMPRADOR".
</p>
...
<p style="page-break-after: always"></p>
<% if(bmoCustomer.getCustomertype().equals(BmoCustomer.TYPE_PERSON)) { %>
...
<% } else { %>
            <table class="detailText" style="font-size: 5pt;" border="0" align="center" cellpading="0" cellspacing="0" width="95%"  >
                ...
                <table class="detailText" style="font-size: 5pt;" border="0" align="center" cellpading="0" cellspacing="0" width="95%">
                    ...
                    <tr>
                        <td class="detailText" style="font-size: 5pt;">
                            <input type="checkbox">ACTA CONSTITUTIVA DEBIDAMENTE INSCRITA EN EL REGISTRO P&Uacute;BLICO
                        </td>
                        <td class="detailText" style="font-size: 5pt;">
