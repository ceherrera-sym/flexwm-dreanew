...
<p align="justify" style="font-size: 12px">
	El presente reglamento tiene como finalidad el logro de la mejor convivencia y calidad de vida de todos los colonos del 
	fraccionamiento contemplando la mejor conservaci&oacute;n de los bienes comunes, el aseo, la seguridad y salubridad de los propietarios. 
	<br>
</p>
<p align="justify" style="font-size: 12px">
	<b>1.</b>	<b>Todo colono est&aacute; obligado a sujetarse a las disposiciones del presente reglamento y r&eacute;gimen de condominio.</b>
	Es responsabilidad de los propietarios y/o sus habitantes (arrendatarios) cumplir y hacer cumplir las reglas establecidas en el 
	r&eacute;gimen de propiedad en condominio inscrito en la escritura p&uacute;blica de la vivienda , as&iacute; como la reglamentaci&oacute;n 
	descrita en el presente documento, aceptando y reconociendo su vigencia, validez e importancia, sujet&aacute;ndose a las disposiciones 
	legales que implique el incumplimiento u omisi&oacute;n de las mismas.
</p>
	
<p align="justify" style="font-size: 12px">
	<b>2.</b>	Todas las viviendas que integran el condominio son para <b>uso habitacional exclusivamente</b>. Cada colono u ocupante usar&aacute; 
	su vivienda en condominio en forma ordenada y tranquila, por lo tanto no podr&aacute; destinarlo a usos contrarios a la moral o las buenas costumbres, 
	ni hacerlo servir a otro objeto distinto del habitacional, ni efectuar acto alguno que perturbe la tranquilidad de los dem&aacute;s  
	condominio o que comprometa la solidez o seguridad, salubridad o comodidad del condominio o incurrir en omisiones que produzcan los mismos resultados. 
</p>
<p align="justify" style="font-size: 12px">
	<b>3.</b>	<b>El colono que realice obras de muros que sean de propiedad com&uacute;n</b>, sin autorizaci&oacute;n del administrador, ser&aacute; 
	responsable de los da&ntilde;os y perjuicios que se causen a los dem&aacute;s colonos y queda obligado a reparar por su exclusiva cuenta 
	los da&ntilde;os que se hubieren causado.to.
</p>
<p align="justify" style="font-size: 12px">
	<b>4.</b>	A los colonos les <b>esta prohibida toda modificaci&oacute;n</b> que ponga en peligro o que afecte la imagen (fachada), estructura, 
	muros de carga u otros elementos esenciales de las viviendas que puedan perjudicar su solidez, seguridad, salubridad o comodidad.
</p>
<p align="justify" style="font-size: 12px">
	<b>5.</b>	Los colonos se obligan a no darle a las viviendas un uso distinto al se&ntilde;alado <b>(uso habitacional)</b>, y por  lo tanto <b>no 
	podr&aacute;n establecer en ellos; oficinas , comercios, dep&oacute;sitos, talleres, etc., ni podr&aacute;n usar sus fachadas y 
	&aacute;reas exteriores como bodegas,</b> por lo que &eacute;stas tendr&aacute;n <b>como &uacute;nico uso el de cocheras para autom&oacute;viles</b>.
</p>
<p align="justify" style="font-size: 12px">
	<b>6.</b>	&Uacute;nicamente se permite la tenencia de mascotas dom&eacute;sticas, siempre y cuando se acaten a las normas sanitarias 
	y se cumpla con las caracter&iacute;sticas de cantidad, tama&ntilde;o, raza y seguridad de los habitantes del fraccionamiento y 
	permanezcan dentro de las viviendas. <b>Queda estrictamente prohibido tener animales que molesten o perturben la tranquilidad de los 
	vecinos (porcinos, ovinos, caprinos, etc. y en general cualquier mascota que genere ruidos, molestias, insalubridad  o inseguridad en los colonos)</b>.
</p>
<p align="justify" style="font-size: 12px">
	<b>7.</b>	<b>Se proh&iacute;be modificar fachadas de las viviendas o colocar cualquier objeto o estructura en la misma</b>.
	Toda fachada de las viviendas deber&aacute; de mantenerse en buen estado. Qued&aacute; estrictamente prohibido cambiar 
	el color de las fachadas de las viviendas , estas deber&aacute;n conservar el mismo color que tiene desde la entrega de la misma.
</p>
<ol type="a" style="font-size: 12px; text-align:justify;">
	<li>
		<b>Cualquier ampliaci&oacute;n o remodelaci&oacute;n de vivienda  podr&aacute; hacerse unicamente teniendo como base el 
		proyecto que proporciona la empresa desarrolladora, solicitando la autorizaci&oacute;n por escrito al &aacute;rea de 
		atenci&oacute;n a clientes (clientes@mdm.mx)</b>. Se deber&aacute; respetar los materiales, colores y dem&aacute;s 
		caracter&iacute;sticas del proyecto, de lo contrario el consejo administrativo y/o administrador podr&aacute; solicitar 
		a las autoridades la suspensi&oacute;n de las obras.
	</li>
</ol>
<p align="justify" style="font-size: 12px">
	<b>8.</b>	<b>Se proh&iacute;be tener corrales al frente , almacenar o reciclar fierro, 
	cart&oacute;n, o cualquier otro material en azoteas y cocheras</b>.
</p>
<p align="justify" style="font-size: 12px">
	<b>9.</b>	<b>La basura deber&aacute; ser depositada indistintamente en los recolectores o el lugar designado para ello;</b> deber&aacute; 
	estar en bolsas bien amarradas, no debe contener objetos cortantes, material descompuesto o animales muertos. 
	Lo anterior con la finalidad de evitar malos olores y focos de infecci&oacute;n.
</p>
<p align="justify" style="font-size: 12px">
	<b>10.</b>	<b>No producir ruidos</b>, ni ejecutar actos que perturben la tranquilidad de los propietarios.
</p>
<p align="justify" style="font-size: 12px">
	<b>11.</b>	Todos los colonos tienen derecho a realizar fiestas en sus viviendas cuando les parezca, 
	pero es su deber <b>respetar las normas establecidas, todo en un ambiente moderado que no moleste a los vecinos</b>.
</p>
<p align="justify" style="font-size: 12px">
	<b>12.</b>	<b>Ning&uacute;n colono puede sacar ropa a secar en lugares a la vista del exterior de sus fachadas o 
	cocheras de su viviendas, azoteas, &aacute;reas comunes o ajardinadas</b>.
</p>
<p align="justify" style="font-size: 12px">
	<b>13.</b>	<b>Queda prohibido el almacenamiento y posesi&oacute;n en sus viviendas o &aacute;reas comunes de 
	sustancias qu&iacute;micas y/o explosivas</b> que sean nocivas para la salud o que puedan causar incendios.
</p>
<p align="justify" style="font-size: 12px">
	<b>14.</b>	<b>El limite m&aacute;ximo de velocidad permitido dentro del fraccionamiento es de 20 km/hr</b>., 
	est&eacute; l&iacute;mite es aplicable a cualquier tipo de veh&iacute;culo ( autom&oacute;vil, cami&oacute;n de carga, 
	motocicleta, cuatrimoto, bicicleta, etc.) as&iacute; mismo deber&aacute;n respetarse el sentido de circulaci&oacute;n establecido en las calles del fraccionamiento, debiendo dar preferencia al peat&oacute;n  en todos los accesos y cruces de calles. 
</p>
<p align="justify" style="font-size: 12px">
	<b>15.</b>	<b>Los colonos deber&aacute;n conformar el comit&eacute; de colonos</b>, el cual ser&aacute; responsable de la 
	contrataci&oacute;n de servicios de seguridad, por lo que cada habitante deber&aacute; contribuir con el pago 
	de una cuota de mantenimiento para cubrir los gastos de la seguridad y todos los bienes comunes de los que gozan los propietarios del fraccionamiento.
</p>
<p align="justify" style="font-size: 12px">
	<b>16.</b>	Los colonos deber&aacute;n <b>participar en las asambleas</b> del condominio y 
	de ser posible en las actividades sociales y de recreaci&oacute;n que se organicen.
</p>
<p align="justify" style="font-size: 12px">
	<b>17.</b>	En caso  de vivienda  vertical, los colonos se obligan a mantener en buen estado la 
	limpieza e imagen del edificio, as&iacute; como a <b>pagar las cuotas comunitarias</b> que se establezcan para dicho fin con car&aacute;cter obligatorio.
</p>
<p align="justify" style="font-size: 12px">
	<b>18.</b>	Es obligaci&oacute;n de todos y cada uno de los colonos a contribuir con la limpieza y orden de su vivienda, 
	evitando la acumulaci&oacute;n de basura y desperdicios fuera de sus domicilio, depositar los desechos 
	org&aacute;nico en bolsa de pl&aacute;stico herm&eacute;ticamente cerradas para evitar malos olores y el 
	incremento de focos de infecci&oacute;n, as&iacute; como abstenerse de tirar basura en la v&iacute;a p&uacute;blica, &aacute;reas verdes y lotes bald&iacute;os.
</p>
<p align="justify" style="font-size: 12px">
	<b>19.</b>	Cualquier  queja o problema que se presente en contra de un propietario o inquilino por incumplimiento 
	de las normas aqu&iacute; establecidas, se har&aacute; acreedor a las <b>sanciones establecidas en la ley de condominos y la asociaci&oacute;n de condominos</b>.
</p>

<p align="justify" style="font-size: 12px">
	Este reglamento tiene car&aacute;cter de obligatorio para todos los colonos de este fraccionamiento y pretende 
	salvaguardar los intereses comunes de los colonos , protegiendo la imagen urbana del desarrollo, la cordial 
	convivencia de sus residentes y la plusval&iacute;a de su patrimonio. 
</p>
