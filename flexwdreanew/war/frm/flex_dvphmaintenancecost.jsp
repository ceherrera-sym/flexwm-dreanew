...
%>
	...
	<body class="default" <%= permissionPrint %>>
		...
		<table border="0" cellspacing="0" width="100%" cellpadding="0" style="font-size: 12px">
			<tr >
				<td >
					...
					<ol type="1" style="text-align:justify">
						...
						<li>
							Los conceptos de mantenimiento que se abarca con el pago son:
								<ol type="1" style="text-align:justify">
									<li>
										Vigilancia de Accesos a la Etapa / Coto.
									</li>
									<li>
										Mantenimiento de &Aacute;reas Verdes comunes.
									</li>
									<li>
										Mantenimiento y Servicios de las &Aacute;reas de Equipamiento Comunes.
									</li>
								</ol>
						</li>
							<br>
						...
						<li>
							Los pagos del mantenimiento deber&aacute;n realizarse mediante dep&oacute;sito o transferencia, a la cuenta de banco:
								<ol type="1" style="text-align:justify">
									...
									<li>
										N&uacute;mero de referencia: (# <b><%= bmoCustomer.getCode().toString(9)%></b>)
									</li>
								</ol>
						</li>
					</ol>
					...
					<p align="justify">
						<br>
						Nota: No se incluye en el mantenimiento a las &aacute;reas privativas (jardinadas de las viviendas, estacionamiento). 
		...
		<table border="0" cellspacing="0" width="100%" cellpadding="0" style="font-size: 12px">
			<tr >
				<td>
				Cualquier duda o comentario al Tel. 01 477 2 12 12 34				
				</td>
			</tr>
		</table>
		<%
