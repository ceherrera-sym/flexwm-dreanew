...
<%
try {
	String title = "Carta de Programaci&oacute;n de Entrega de Vivienda Vallarta";
			...
			<tr class="documentText">
				<td >
					...
					<p align="justify">
						...
						de la ciudad Bah&iacute;a de Banderas, Nayarit.
					</p>
					<p align="justify">
			...
			<tr class="documentText">
				<td >
					...
					<p align="justify">
						...
						<%= bmoDevelopment.getName().toString().toUpperCase() %></b>
						<!--<input type="text"  size="35" style="font-weight: bold; border: 0" class="documentText" value="<%//= bmoDevelopment.getName().toString().toUpperCase() %>">-->
						que se encuentra entre las calles
						<input type="text" size="35" style="border: 0" class="documentText"> 
						de la ciudad Bah&iacute;a de Banderas, Nayarit.
					</p>
					<p align="justify">
