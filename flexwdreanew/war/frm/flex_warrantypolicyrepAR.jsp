...
%>
	...
	<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px">
		...
		<tr >
			<td  align="justify" colspan="2" >
				Primera.- "El Constructor", se obliga a responder por las fallas de impermeabilizaci&oacute;n, que 
				aparecieran en la vivienda durante un periodo de 3 a&ntilde;os contados a partir de la fecha de entrega. 
			</td>
		</tr>
		<tr><td colspan="2">&nbsp;</td></tr>
		...
		<tr >
			<td  align="justify" colspan="2" >
				Segunda.- "El Constructor", se compromete frente a "El Acreditado" y/o sus beneficiarios, durante el t&eacute;rmino de 1 a&ntilde;o a 
