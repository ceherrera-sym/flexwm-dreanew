	...
	<body class="default" <%= permissionPrint %>>
		...
		<table width="90%" align="center" style="font-size: 12px">
			...
			<tr>
				<td>
					<p align="justify">
						Por este conducto emitimos la m&aacute;s amplia garant&iacute;a contra vicios ocultos e impermeabilizaci&oacute;n por dos a&ntilde;os a partir de la presente fecha 
