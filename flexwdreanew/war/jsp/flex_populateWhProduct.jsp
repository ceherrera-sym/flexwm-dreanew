...
<%
	...
	String programDescription = "Importacion de Productos";
%>

<html>
<head>
<title>:::Importacion de Productos:::</title>
...
<table width="100%" height="50%" border="0" align="center"  class="detailStart">	
    <tr class="reportSubTitle">
        <td colspan="1" align="left" width="99%" height="35" class="reportCellEven">
          ...
          <li>Formato (| = tab): Clave Secc. Almacen | Clave Producto. | Nombre Producto | Cantidad (1 si es #serie) | No. Serie</li>
        </td>
    </tr>    
    <TR>
        <td colspan="3">  
            <TABLE cellpadding="0" cellspacing="0" border="0"  width="80%">
			    <FORM action="flex_revisionWhProduct.jsp" method="POST" name="listFilter">
