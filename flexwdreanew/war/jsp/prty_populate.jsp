...
<html>
<head>
<title>:::Importación de Viviendas:::</title>
    ...
    <tr class="reportSubTitle">
        <td colspan="1" align="left" width="99%" height="35" class="reportCellEven">
          <li>Se recomienda elaborar preparaci&oacute;n en archivo de texto, seleccionar y pegar en el campo siguiente.</li>          
        	<li>Formato (| = tab):Clave Etapa | Clave Modelo | Clave Paq. | Clave Manzana | Descripci&oacute;n | Privada	 | Calle | N&uacute;mero | M2 Terreno | M2.T Comunal | M2 Construcci&oacute;n | Revisado
          | Empresa | inm Abierto | Habitable | Ciudad |
          </li>
        </td>
    </tr>    
    <TR>
