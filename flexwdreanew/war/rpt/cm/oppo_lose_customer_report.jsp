...
try {
	// Inicializar variables
 	String title = "Oportunidades Perdidas Agrupadas por Cliente";
...
if (!(currencyId > 0)) {
	...
	while (pmCurrencyWhile.next()) { %>
		<table class="report" width="100%">
			...
			chartSql = " SELECT cust_customerid, cust_code, cust_displayname, cust_legalname, " +
					...
					groupFilter + where + 
					" GROUP BY cust_customerid ORDER BY cust_code ASC";
		    ...
		    <script type="text/javascript">
		      ...
		      function drawChart() {
		        var data = google.visualization.arrayToDataTable([
		          ['Cliente', 'Oportunidades Perdidas por Cliente'],
		       <% 
...
<%	} // Fin pmCurrencyWhile
		...
		int currencyIdOrigin = 0, currencyIdDestiny = 0;
      	...
      	pmConnChartGroup.open();
	   	...
	   	<script type="text/javascript">
		   	...
		   	function drawChart() {
		   		var data = google.visualization.arrayToDataTable([
                      ['Clientes', 'Oportunidades Perdidas por Cliente'],
                      <% 
                      String statusCaptionDonutChart = "";
                      // Contar  las oportunidades perdidas por motivo para la grafica DONUT
                      chartSql = " SELECT cust_customerid, cust_code, cust_displayname, cust_legalname, cust_customertype, " + 
	...
	<table class="report" width="100%">
    	...
    	// Filtra oportunidades perdidas por cliente
