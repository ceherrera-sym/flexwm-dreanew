...
<% 
	// Inicializar variables
 	String title = "Reporte de Manzanas/Torres";
	System.out.println("\n Fecha: " +  SFServerUtil.nowToString(sFParams, sFParams.getDateTimeFormat()) 
	+ " Reporte: "+title
	+ " Usuario: " + sFParams.getLoginInfo().getEmailAddress()); 
   	String sql = "", sqldvbl = "", where = "", filters = "", startDate = "", endDate = "", readyDate = "", readyDateEnd ="";
...
<table class="report">
			<tr class="">		
				...
				<td class="reportHeaderCell">Etapa Des.</td>
				<td class="reportHeaderCell">Secci&oacute;n</td>
				<td class="reportHeaderCell">En Proceso</td>
				<td class="reportHeaderCell">Mza. Abierta.</td>
				<td class="reportHeaderCell">Mza. Temporal</td>
				...
				<td class="reportHeaderCell">Historial</td>
			</tr>
			<%
				int i = 1;
				double process = 0;
			...
			%>
			        <tr class="reportCellEven">
		                ...
		                <%= HtmlUtil.formatReportCell(sFParams, HtmlUtil.stringToHtml(pmDevelopmentBlocks.getString("developmentblocks","dvbl_name")), BmFieldType.STRING) %>
		                <%= HtmlUtil.formatReportCell(sFParams, HtmlUtil.stringToHtml(pmDevelopmentBlocks.getString("developmentblocks","dvbl_description")), BmFieldType.STRING) %>
		                <%= HtmlUtil.formatReportCell(sFParams, pmDevelopmentBlocks.getString("developments","deve_code"), BmFieldType.CODE) %>
		                <%= HtmlUtil.formatReportCell(sFParams, pmDevelopmentBlocks.getString("developmentphases","dvph_code"), BmFieldType.CODE) %>
		                <%= HtmlUtil.formatReportCell(sFParams, pmDevelopmentBlocks.getString("developmentblocks","dvbl_section"), BmFieldType.STRING) %>
		                <%= HtmlUtil.formatReportCell(sFParams, ((pmDevelopmentBlocks.getBoolean("dvbl_statusprocess")) ? "Si" : "No"), BmFieldType.STRING) %>		                
		                <%= HtmlUtil.formatReportCell(sFParams, ((pmDevelopmentBlocks.getBoolean("dvbl_isopen")) ? "Si" : "No"), BmFieldType.STRING) %>
		                <%= HtmlUtil.formatReportCell(sFParams, ((pmDevelopmentBlocks.getBoolean("dvbl_istemporally")) ? "Si" : "No"), BmFieldType.STRING) %>
		                ...
		                <%= HtmlUtil.formatReportCell(sFParams, pmDevelopmentBlocks.getString("developmentblocks", "dvbl_processpercentage"), BmFieldType.PERCENTAGE) %> 
		                <%= HtmlUtil.formatReportCell(sFParams, pmDevelopmentBlocks.getString("developmentblocks", "dvbl_habitabilityhistory"), BmFieldType.STRING) %>
			        </tr>
	    <%
	       i++;
	    }
