...
<%
	...
	String sql = "", where = "", groupFilter = "", whereGroup = "", whereRacc = "";
   	...
   	String filters = "", collaboratorProfile = "",creditTypeId = "";
   	int  customerId = 0, salesmanId = 0, regionId = 0, programId = 0, profileId = 0; 
...
<table class="report" border="0">
	<tr>
		...
		<td class="reportHeaderCell">Zona</td>
...
<%				
	...
	sql = " SELECT COUNT(*) as contador FROM " + SQLUtil.formatKind(sFParams, " credits ") +
			  ...
			  " LEFT JOIN " + SQLUtil.formatKind(sFParams, " regions")+" ON (cust_regionid = regi_regionid) " +
		      ...
		      sql += " ORDER BY regi_regionid, cred_startdate, cred_salesuserid, cred_creditid" ;
...
%>	
		<tr class="reportCellEven">
	    	...
	    	<%= HtmlUtil.stringToHtml(HtmlUtil.formatReportCell(sFParams, "" + pmConn.getString("regions", "regi_name"), BmFieldType.CODE)) %>
	    	<%	    	
	    	double sumFailure = 0;
	    	//Mostrar cxc
