...
<%		
	...
	sql = " SELECT COUNT(*) as contador FROM "+ SQLUtil.formatKind(sFParams,"credits ") +
		      ...
		      where +
			  " ORDER BY regi_regionid, cred_startdate, cred_salesuserid, cred_creditid" ;
		      int count =0;
				//ejecuto el sql
...
%>	
		<tr class="reportCellEven">
	    	...
	    	<% 	} %>
	    	<%= HtmlUtil.stringToHtml(HtmlUtil.formatReportCell(sFParams, "" + pmConn.getString("regions", "regi_name"), BmFieldType.STRING)) %>
