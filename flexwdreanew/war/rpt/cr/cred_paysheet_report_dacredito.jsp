...
//					System.out.println("datePayout: "+startDatePayment);
					...
					int daysPayout = 0;
					if (pmConn.getString("credittypes", "crty_type").equals("" + BmoCreditType.TYPE_DAILY)) {
						daysPayout = 1;
					} else if (pmConn.getString("credittypes", "crty_type").equals("" + BmoCreditType.TYPE_WEEKLY)) {
						daysPayout = 7;
