...
<%
	...
	NumberFormat formatCurrency = NumberFormat.getCurrencyInstance(locale);
   	...
   	String orderStatus = "", creditStatus = "", startDate = "", endDate = "", whereGroup = "", collaboratorGroup = "", amountStart = "", amountEnd = "";
   	int programId = 0, customerId = 0, salesmanId = 0, locationId = 0, profileId = 0, birthdateByMonth = 0,
   			industryId = 0 ;
...
//         where += " AND (cred_customerid = " + customerId + " OR crgu_customerid = " + customerId + ")";
    ...
    if (locationId > 0) {
 		where += " AND cust_locationid = " + locationId; // el filtro aplica a clientes!!
