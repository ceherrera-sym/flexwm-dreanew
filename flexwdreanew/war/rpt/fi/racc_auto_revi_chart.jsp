	...
	pmConn.open();
 	...
 	// Asigna usuario seleccionado
   	...
   	for (int i = 1; i <= 12; i++) {
   		...
   		sql = "SELECT sum(racc_payments) as total FROM " + SQLUtil.formatKind(sFParams, "raccounts")
   			+ " WHERE racc_dueDate BETWEEN CAST('" + currentYear + "-" + i + "-01' AS DATE) "
	 ...
	 <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
	    <script type="text/javascript">
	      ...
	      function drawChart() {
	        ...
	        var options = {
	          chart: {
	            title: 'Cobrado y Por Cobrar',
	            subtitle: 'Cuentas por pagar: <%= "Cobrado " %>-<%= "Por Cobrar" %>',
	          },
