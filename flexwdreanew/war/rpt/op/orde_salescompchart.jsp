	...
	pmConn.open();
 	...
 	// Asigna usuario seleccionado
   	...
   	for (int i = 1; i <= 12; i++) {
   		...
   		sql = "SELECT SUM(orde_total) as total FROM " + SQLUtil.formatKind(sFParams, "orders")
   			+ " WHERE orde_lockstart BETWEEN CAST('" + lastYear + "-" + i + "-01' AS DATE) "
   		...
   		// Suma ventas del año pasado
   		sql = "SELECT SUM(orde_total) as total FROM " + SQLUtil.formatKind(sFParams, "orders")
   			+ " WHERE orde_lockstart BETWEEN CAST('" + currentYear + "-" + i + "-01' AS DATE) "
