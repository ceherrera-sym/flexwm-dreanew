...
<%
	...
	int programId = 0,wflowtypeId=0, customerId = 0, cols = 0, areaId = 0, orderId = 0, industryId = 0, userId = 0,
			productId = 0, showProductExtra = 0, currencyId = 0, dynamicColspan = 0, dynamicColspanMinus = 0,dColspan = 14;
